...
def test_add_session_with_non_existing_userID():
    ...
    response = client.post("/session/record_start", json=payload)
...
def test_insert_test_duplicated_session():
    ...
    try:
        ...
        another_response = client.post("/session/record_start", json=payload)
...
def test_update_session_end_time_successfully():
    ...
    try:
        ...
        endTime_response = client.post("/session/record_end", json=endTime_payload)
